import { Box, ConvexPolyhedron, Cylinder, Shape, Sphere, Quaternion as CQuaternion, Trimesh, Vec3 } from 'three/examples/js/libs/cannon.js';
...
function getMeshes (object) {
  ...
  object.traverse(function (o) {
    //console.log(o.type);
    if (o.type === 'Mesh' || o.type === 'SkinnedMesh') { //'SkinnedMesh'
      meshes.push(o); 
    }
  });
  return meshes;
